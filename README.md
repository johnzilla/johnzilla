...
- [honeyprompt](https://github.com/johnzilla/honeyprompt) - Terminal-first security tool detecting unsafe AI browsing agent behavior using honeypot pages and prompt-injection canaries
